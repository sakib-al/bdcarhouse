...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Carmodel List</h1>
        <ul class="breadcrumb">
            <a href="{{ route('admin.carmodel.add') }}" class="btn btn-info"><i class="fa fa-plus">Add {{ $title }}</i></a>
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        ...
                        <table class="table">
                            ...
                            @if(isset($carmodel) && count($carmodel) > 0 )
                            @foreach($carmodel as $key => $row)
                            <tbody>
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ $row->name }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.carmodel.edit',$row->id)}}" class="btn btn-warning btn-sm">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{!! route('admin.carmodel.delete', $row->id) !!}" method="post">
                                                            {{ csrf_field() }}
